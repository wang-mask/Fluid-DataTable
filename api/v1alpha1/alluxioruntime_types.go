...
func (in *AlluxioRuntimeList) Deadline() (deadline time.Time, ok bool) {
	panic("implement me")
}

func (in *AlluxioRuntimeList) Done() <-chan struct{} {
	panic("implement me")
}

func (in *AlluxioRuntimeList) Err() error {
	panic("implement me")
}

func (in *AlluxioRuntimeList) Value(key interface{}) interface{} {
	panic("implement me")
}
