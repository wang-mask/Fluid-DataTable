...
import (
	...
	"Fluid-Datatable/pkg/utils/lifecycle"
	"context"
	"fmt"
	...
	//	"Fluid-Datatable/pkg/ddc/base/portallocator"
	"Fluid-Datatable/pkg/utils"
	//	"Fluid-Datatable/pkg/utils/dataset/lifecycle"
	"Fluid-Datatable/pkg/utils/helm"
...
func (e *AlluxioEngine) destroyWorkers(expectedWorkers int32) (currentWorkers int32, err error) {
	...
	if expectedWorkers >= 0 {
		...
		nodes, err = e.sortNodesToShutdown(nodeList.Items, true)
		if err != nil {
			return currentWorkers, err
		}
