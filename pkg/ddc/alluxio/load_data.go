...
import (
	//	cdataload "Fluid-Datatable/pkg/dataload"
	"Fluid-Datatable/pkg/ddc/alluxio/operations"
)
...
/*func (e *AlluxioEngine) CheckExistenceOfPath(targetDataload datav1alpha1.DataLoad) (notExist bool, err error) {
	podName, containerName := e.getMasterPodInfo()
	fileUtils := operations.NewAlluxioFileUtils(podName, containerName, e.namespace, e.Log)
