...
import (
	...
	"Fluid-Datatable/pkg/ddc"
	"Fluid-Datatable/pkg/ddc/base"
)

const (
	runtimeType                  = "alluxio"
	runtimeResourceFinalizerName = "alluxio-runtime-controller-finalizer"
)

// getRuntime gets the runtime
func (r *RuntimeReconciler) getRuntime(ctx cruntime.ReconcileRequestContext) (*datav1alpha1.AlluxioRuntime, error) {
